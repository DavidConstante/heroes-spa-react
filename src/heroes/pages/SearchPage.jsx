...
const SearchPage = () => {
    ...
    return (
        <div className='p-16 flex justify-around  bg-slate-300 h-screen '>
            ...
            <div className='mx-8 flex flex-col w-1/2'>
                ...
                {
                    heroes.length !== 0 ?
                        <div className='grid grid-cols-2 bg-slate-400 my-4 p-4 rounded-md overflow-scroll scrollbar-hide'>
